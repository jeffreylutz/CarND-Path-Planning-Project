...
//  double ego_yaw;
//  double ego_speed;
//  double REAR_SAFE_DISTANCE; //meters
//  double ref_v;
...
//        else if ((check_car_future_s < ego_future_s) && (abs(check_car_future_s - ego_future_s) < REAR_SAFE_DISTANCE)) {
//
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          vector<vector<double>> path = ego.realize_state(previous_path_x, previous_path_y, map_waypoints_x,
